                        ...
                        <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <div class="d-flex flex-wrap fw-bold fs-6 mb-4 pe-2">
                                    <p class="d-flex align-items-center text-gray-400 me-5 mb-2">{{ $item->position}}</p>
                                </div>
                                
                                <div class="d-flex flex-wrap fw-bold fs-6 mb-4 pe-2">
                                    <p class="d-flex align-items-center text-gray-400 me-5 mb-2">{{ $item->jargon }}</p>
                                </div>
                                <!--end::Info-->
                            </div>
                            <!--end::User-->
                            ...
                            <div class="d-flex my-4">
                                <a href="{{ route("admin.team-edit", ["id" => $item->id]) }}" class="btn btn-sm btn-light me-2">
                                ...
                                <form action="{{ route("admin.team-delete", ["id" => $item->id]) }}" method="post" class="d-inline">
                                    @csrf
                                    @method("DELETE")

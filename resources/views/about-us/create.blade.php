    ...
    <div class="container-xxl" id="kt_content_container">
        ...
        <div class="card mb-5 mb-xl-10">
            ...
            <div id="kt_account_profile_details" class="collapse show">
                <!--begin::Form-->
                <form id="kt_account_profile_details_form" class="form" method="POST" enctype="multipart/form-data" action="{{ route("admin.about-us.post") }}">
                    <!--begin::Card body-->
                    ...
                    <div class="card-footer d-flex justify-content-end py-6 px-9">
                        @csrf
                        <a href="{{ route("admin.about-us") }}" class="btn btn-danger btn-active-light-primary me-2">Cancel</a>

                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                    ...
                    <div class="card card-custom gutter-b card-stretch">
                        ...
                        <div class="card-body pt-4">
                            ...
                            <p class="mb-7"> {{ $item->subtitle }}
                            <!--end::Desc-->
                         
                            <div class="row">
                                <div class="col">
                                    <a href="{{ route("admin.services-edit", ["id" => $item->id]) }}" class="mt-7 btn btn-block btn-sm btn-light-success font-weight-bolder text-uppercase py-4">Edit</a>
                                </div>
                                <div class="col">
                                    <form action="{{ route("admin.services-delete", ["id" => $item->id ]) }}" method="post">
                                        @method("DELETE")
                                        @csrf

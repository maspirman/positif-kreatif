...
<html lang="en">
	<!--begin::Head-->
	<head><base href="">
		<title>Positif Kreatif - @yield('title')</title>
					...
					<div class="aside-nav d-flex flex-column align-lg-center flex-column-fluid w-100 pt-5 pt-lg-0" id="kt_aside_nav">
						...
						<div id="kt_aside_menu" class="menu menu-column menu-title-gray-600 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-bold fs-6" data-kt-menu="true">
							<div class="menu-item py-3">
								<a class="menu-link active menu-center" href="{{ route("home") }}" title="Dashboard" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
							...
							<div data-kt-menu-trigger="click" data-kt-menu-placement="right-start" class="menu-item py-3">
								<span class="menu-link menu-center" title="Menu" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
									<span class="menu-icon me-0">
								...
								<div class="menu-sub menu-sub-dropdown w-225px px-1 py-4">
									...
									<div class="menu-item menu-accordion" >
										<a class="menu-link" href="{{ route("admin.portofolio") }}">
											<span class="menu-bullet">
												<span class="bullet bullet-dot"></span>
											</span>
									...
									<div class="menu-item menu-accordion">
										<a class="menu-link" href="{{ route("admin.about-us") }}">
											<span class="menu-bullet">
												<span class="bullet bullet-dot"></span>
											</span>

                    ...
                    <div class="wizard wizard-1" id="kt_projects_add" data-wizard-state="step-first" data-wizard-clickable="true">
                        ...
                        <div class="row justify-content-center my-10 px-8 my-lg-15 px-lg-10">
                            <div class="col-xl-12 col-xxl-7">
                                <!--begin::Form Wizard-->
                                <form class="form" id="kt_projects_add_form" action="{{ route("admin.client-update", ["id" => $client->id]) }}" method="POST" enctype="multipart/form-data">
                                    <!--begin::Step 1-->
                                            ...
                                            <div class="col-xl-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9 col-xl-9">
                                                        <input class="form-control form-control-lg form-control-solid" required name="name" type="text" value="{{ $client->name }}" />
                                                    </div>
                                                </div>
                                                <div class="form-group row">

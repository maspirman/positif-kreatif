...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class="container-xxl" id="kt_content_container">
        ...
        <div class="mb-5 mb-xl-10 d-flex justify-content-end">
            <a href="{{ route("admin.testimonial-create")}}" class="btn btn-info">Add Testimonial</a>
        </div>
                    ...
                    <div class="flex-grow-1">
                        ...
                        <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <!--begin::Name-->
                                <div class="d-flex align-items-center mb-2">
                                    <p class="text-gray-900 fs-4 me-1">{{$item->pesan}}</p>
                                </div>
                                <!--end::Name-->
                            </div>
                            <!--end::User-->
                            ...
                            <div class="d-flex my-4">
                                <a href="{{ route("admin.testimonial-edit", ["id" => $item->id]) }}" class="btn btn-sm btn-light me-2">
                                ...
                                <form action="{{ route("admin.testimonial-delete", ["id" => $item->id]) }}" method="post" class="d-inline">
                                    @csrf
                                    @method("DELETE")

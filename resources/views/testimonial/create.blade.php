                    ...
                    <div class="wizard wizard-1" id="kt_projects_add" data-wizard-state="step-first" data-wizard-clickable="true">
                        ...
                        <div class="row justify-content-center my-10 px-8 my-lg-15 px-lg-10">
                            <div class="col-xl-12 col-xxl-7">
                                <!--begin::Form Wizard-->
                                <form class="form" id="kt_projects_add_form" action="{{ route("admin.testimonial") }}" method="POST" enctype="multipart/form-data">
                                    <!--begin::Step 1-->
                                    <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                                        <h3 class="mb-10 font-weight-bold text-dark">testimonial Details:</h3>
                                        <div class="row">
                                            <div class="col-xl-12">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9 col-xl-9">
                                                        <input class="form-control form-control-lg form-control-solid" required name="pesan" type="text" />
                                                    </div>
                                                </div>
                                                <div class="form-group row">
